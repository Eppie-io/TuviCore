...
{
    /// <summary>
    /// Provides derived public keys from a master key.
    /// </summary>
    public interface IKeyDerivationPublicKeyProvider
    {
    ...
    internal sealed class EccKeyDerivationPublicKeyProvider : IKeyDerivationPublicKeyProvider
    {
