...
namespace Tuvi.Core.Mail.Impl.Tests
{
    public class MailServiceTests
    {
        ...
        public void ConnectWithIncorrectServerAddressTest()
        {
            ...
            Assert.ThrowsAsync<ConnectionException>(new global::System.Func<global::System.Threading.Tasks.Task>(async () => await service.ConnectAsync(default).ConfigureAwait(false)));
        }
