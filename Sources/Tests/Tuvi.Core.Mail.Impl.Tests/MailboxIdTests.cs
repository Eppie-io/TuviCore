...
namespace Tuvi.Core.Mail.Impl.Tests
{
    ...
    public class MailboxIdTests
    {
        ...
        {
            var ex = Assert.Throws<ArgumentNullException>(new global::System.Action(() => new MailboxId(null)));
        ...
        {
            var ex = Assert.Throws<ArgumentException>(new global::System.Action(() => new MailboxId(publicKey)));
            Assert.That(ex.ParamName, Is.EqualTo("publicKey"));
        }
        ...
        public void ConstructorRejectsInvalidLengthBoundaries()
        {
            ...
            var ex1 = Assert.Throws<ArgumentException>(new global::System.Action(() => new MailboxId(tooShort)));
            Assert.That(ex1.ParamName, Is.EqualTo("publicKey"));

            // Boundary check: Length + 1
            string tooLong = ValidBase32E + "a";
            var ex2 = Assert.Throws<ArgumentException>(new global::System.Action(() => new MailboxId(tooLong)));
        ...
        public void ConstructorRejectsInvalidCharacters(string invalidChar)
        {
            ...
            var ex = Assert.Throws<ArgumentException>(new global::System.Action(() => new MailboxId(invalidKey)));
            Assert.That(ex.ParamName, Is.EqualTo("publicKey"));
        }
        ...
        public void ConstructorRejectsPublicKeyWithWhitespace()
        {
            ...
            var ex = Assert.Throws<ArgumentException>(new global::System.Action(() => _ = new MailboxId(keyWithWhitespace)));
            Assert.That(ex.ParamName, Is.EqualTo("publicKey"));
        }
        ...
        public void ConstructorRejectsPublicKeyWithInnerWhitespace()
        {
            ...
            var ex = Assert.Throws<ArgumentException>(new global::System.Action(() => new MailboxId(innerSpace)));
            Assert.That(ex.ParamName, Is.EqualTo("publicKey"));
        }
