...
namespace Tuvi.Core.Dec.Web.Impl.Tests
{
    public class WebDecStorageClientTests
    {
        ...
        public void ClaimNameAsyncThrowsOnEmptyName()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(new System.Func<System.Threading.Tasks.Task>(async () => await client.ClaimNameAsync("", "ADDR", "sig", _ct).ConfigureAwait(false)));
        }
        ...
        public void ClaimNameAsyncThrowsOnEmptyAddress()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(new System.Func<System.Threading.Tasks.Task>(async () => await client.ClaimNameAsync("name", "", "sig", _ct).ConfigureAwait(false)));
        }
        ...
        public void GetAddressByNameAsyncThrowsOnEmptyName()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(new System.Func<System.Threading.Tasks.Task>(async () => await client.GetAddressByNameAsync("", _ct).ConfigureAwait(false)));
        }
        ...
        public void GetAddressByNameAsyncNotFoundReturnsEmptyString()
        {
            ...
            Assert.DoesNotThrowAsync(new System.Func<System.Threading.Tasks.Task>(async () => await client.GetAddressByNameAsync("unknown", _ct).ConfigureAwait(false)));
        }
