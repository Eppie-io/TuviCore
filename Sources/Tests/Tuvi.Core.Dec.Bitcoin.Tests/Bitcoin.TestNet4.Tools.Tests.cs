...
namespace Tuvi.Core.Dec.Bitcoin.Tests
{
    public sealed class ToolsTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>((Action)() => Tools.DeriveBitcoinAddress(null, 0, 0));
        }

        [Test]
        public void GetBitcoinAddressFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenAccountIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>((Action)() => Tools.DeriveBitcoinAddress(MasterKey, -1, 0));
        }

        [Test]
        public void GetBitcoinAddressFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenIndexIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>((Action)() => Tools.DeriveBitcoinAddress(MasterKey, 0, -1));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>((Action)() => Tools.DeriveBitcoinSecretKeyWif(null, 0, 0));
        }

        [Test]
        public void GetBitcoinSecretKeyWIFFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenAccountIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>((Action)() => Tools.DeriveBitcoinSecretKeyWif(MasterKey, -1, 0));
        }

        [Test]
        public void GetBitcoinSecretKeyWIFFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenIndexIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>((Action)() => Tools.DeriveBitcoinSecretKeyWif(MasterKey, 0, -1));
        }
