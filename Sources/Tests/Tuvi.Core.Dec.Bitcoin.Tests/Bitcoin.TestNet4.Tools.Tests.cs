...
namespace Tuvi.Core.Dec.Bitcoin.Tests
{
    public sealed class ToolsTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(new System.Action(() => Tools.DeriveBitcoinAddress(null, 0, 0)));
        }

        [Test]
        public void GetBitcoinAddressFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenAccountIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>(new System.Action(() => Tools.DeriveBitcoinAddress(MasterKey, -1, 0)));
        }

        [Test]
        public void GetBitcoinAddressFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenIndexIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>(new System.Action(() => Tools.DeriveBitcoinAddress(MasterKey, 0, -1)));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(new System.Action(() => Tools.DeriveBitcoinSecretKeyWif(null, 0, 0)));
        }

        [Test]
        public void GetBitcoinSecretKeyWIFFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenAccountIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>(new System.Action(() => Tools.DeriveBitcoinSecretKeyWif(MasterKey, -1, 0)));
        }

        [Test]
        public void GetBitcoinSecretKeyWIFFromMasterKeyThrowsArgumentOutOfRangeExceptionWhenIndexIsNegative()
        {
            Assert.Throws<ArgumentOutOfRangeException>(new System.Action(() => Tools.DeriveBitcoinSecretKeyWif(MasterKey, 0, -1)));
        }
        ...
        {
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => Tools.RetrievePublicKeyAsync(null)));
        }

        [Test]
        public void GetPublicKeyAsyncThrowsArgumentNullExceptionWhenAddressIsEmpty()
        {
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => Tools.RetrievePublicKeyAsync(string.Empty)));
        }
        ...
        {
            // config null
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => BitcoinToolsImpl.BroadcastTransactionAsync(null, "tx", new HttpClient())));

            // txHex null
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => BitcoinToolsImpl.BroadcastTransactionAsync(BitcoinNetworkConfig.TestNet4, null, new HttpClient())));

            // httpClient null
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => BitcoinToolsImpl.BroadcastTransactionAsync(BitcoinNetworkConfig.TestNet4, "tx", null)));
        }
        ...
        public void ActivateBitcoinAddressThrowsOnBuildFail()
        {
            ...
            using (var httpClient = new HttpClient(handlerMock.Object))
            {
                Assert.ThrowsAsync<InvalidOperationException>(new System.Func<System.Threading.Tasks.Task>(() => BitcoinToolsImpl.ActivateBitcoinAddressAsync(BitcoinNetworkConfig.TestNet4, MasterKey, 0, 0, httpClient)));
            }
        }
        ...
        {
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => BitcoinToolsImpl.ActivateBitcoinAddressAsync(BitcoinNetworkConfig.TestNet4, MasterKey, 0, 0, null)));
        }
