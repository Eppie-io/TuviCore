    ...
    public class BackupSerializationTests : BaseBackupTest
    {
        ...
        public async Task BackupParseIfNoObjectAsync()
        {
            using (var backup = new MemoryStream())
            {
                ...
                Assert.ThrowsAsync<BackupDeserializationException>(new System.Func<System.Threading.Tasks.Task>(() => parser.GetAccountsAsync()));
            }
        }
        ...
        public async Task ParseUnsupportedBackupAsync()
        {
            ...
            await Task.Run(() =>
            {
                ...
                Assert.ThrowsAsync<BackupParsingException>(new System.Func<System.Threading.Tasks.Task>(() => parser.ParseBackupAsync(backupData)));
            }).ConfigureAwait(true);
        }
