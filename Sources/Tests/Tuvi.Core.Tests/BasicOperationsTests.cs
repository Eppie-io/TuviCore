...
namespace Tuvi.Core.Tests
{
    public class BasicOperationsTests : CoreTestBase
    {
        ...
        public async Task SendMessageShouldThrow()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => { return core.SendMessageAsync(null, false, false, default); }));
        }
        ...
        public async Task SendMessageShouldNotThrow()
        {
            ...
            Assert.DoesNotThrowAsync(new System.Func<System.Threading.Tasks.Task>(() => { return core.SendMessageAsync(message, false, false, default); }));
        ...
        public async Task SendSignedEncryptedMessageShouldThrow()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => { return core.SendMessageAsync(null, encrypt: true, sign: true, default); }));
        }
        ...
        public async Task SendSignedEncryptedMessageShouldNotThrow()
        {
            ...
            Assert.DoesNotThrowAsync(new System.Func<System.Threading.Tasks.Task>(() => { return core.SendMessageAsync(message, encrypt: true, sign: true, It.IsAny<CancellationToken>()); }));
        ...
        public async Task SendSignedMessageShouldThrow()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => { return accountService.SendMessageAsync(null, encrypt: false, sign: true, default); }));
        }
        ...
        public async Task SendSignedMessageShouldNotThrow()
        {
            ...
            Assert.DoesNotThrowAsync(new System.Func<System.Threading.Tasks.Task>(() => { return core.SendMessageAsync(message, encrypt: false, sign: true, default); }));
            mailBox.Verify(x => x.SendMessageAsync(It.IsNotNull<Message>(), It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task SendEncryptedMessageShouldThrow()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(new System.Func<System.Threading.Tasks.Task>(() => { return accountService.SendMessageAsync(null, encrypt: true, sign: false, default); }));
        }
        ...
        public async Task SendEncryptedMessageShouldNotThrow()
        {
            ...
            Assert.DoesNotThrowAsync(new System.Func<System.Threading.Tasks.Task>(() => { return core.SendMessageAsync(message, encrypt: true, sign: false, default); }));
            mailBox.Verify(x => x.SendMessageAsync(It.IsNotNull<Message>(), It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task SynchronizeFullNoRemoteTest()
        {
            ...
            Assert.DoesNotThrowAsync(new System.Func<System.Threading.Tasks.Task>(async () => await accountService.SynchronizeAsync(true, default).ConfigureAwait(true)));
        }
